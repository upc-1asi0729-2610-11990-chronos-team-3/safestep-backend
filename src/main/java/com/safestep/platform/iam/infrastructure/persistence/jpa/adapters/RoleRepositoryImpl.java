...
import com.safestep.platform.iam.infrastructure.persistence.jpa.assemblers.RolePersistenceAssembler;
import com.safestep.platform.iam.infrastructure.persistence.jpa.repositories.RolePersistenceRepository;
...
public class RoleRepositoryImpl implements RoleRepository {
    ...
    public List<Role> findAll() {
        return rolePersistenceRepository.findAll().stream().map(RolePersistenceAssembler::toDomainFromPersistence)
                .toList();
    }

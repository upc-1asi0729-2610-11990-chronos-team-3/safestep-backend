package com.safestep.platform.iam.infrastructure.tokens.jwt.services;
...
/**
 * Token service implementation for JWT tokens. This class is responsible for generating and validating JWT tokens. It
 * uses the secret and expiration days from the application.properties file.
 */
@Service
@Slf4j
public class TokenServiceImpl implements BearerTokenService {
    ...
    /**
     * This method generates a JWT token from a username and a secret. It uses the default expiration days from the

package com.safestep.platform.iam.infrastructure.authorization.sfs.configuration;

import com.safestep.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
 ...
 * <p>
 * This class is responsible for configuring the web security. It enables the method security and configures the
 * security filter chain. It includes the authentication manager, the authentication provider, the password encoder and
...
public class WebSecurityConfiguration {
     ...
     *            The {@link AuthenticationConfiguration} object with the authentication configuration
     *
     ...
     *
     * @return The {@link DaoAuthenticationProvider} authentication provider with the user details service and the
     *         password encoder
     */
    @Bean
    ...
    /**
     * This method creates the security filter chain. It also configures the http security.
     *
     * @param http
     *            The {@link HttpSecurity} object to configure with the security filter chain
     *
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/api/v1/authentication/**", "/v3/api-docs/**", "/swagger-ui.html",

package com.safestep.platform.iam.infrastructure.authorization.sfs.model;
...
/**
 * This class is used to build the UsernamePasswordAuthenticationToken object that is used to authenticate the user.
 */

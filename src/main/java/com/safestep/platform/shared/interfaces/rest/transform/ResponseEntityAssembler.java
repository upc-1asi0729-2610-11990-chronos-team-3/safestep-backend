...
public final class ResponseEntityAssembler {
    ...
    /**
     * Converts a Result into an HTTP response using the provided success resource assembler. Failure responses are
     * delegated to ErrorResponseAssembler.
     *
     * @param result
     *            the application result
     * @param successResourceAssembler
     *            function that maps success value to response resource
     * @param successStatus
     *            HTTP status to use for successful responses
     * @param <T>
     *            success value type
     * @param <R>
     *            success response resource type
     *
     * @return response entity for success or failure
     */
    public static <T, R> ResponseEntity<?> toResponseEntityFromResult(Result<T, ApplicationError> result,
            Function<T, R> successResourceAssembler, HttpStatusCode successStatus) {

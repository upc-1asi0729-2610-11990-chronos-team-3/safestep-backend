...
/**
 * Represents the result of a command or operation that can either succeed with a value or fail with an error. This type
 * encodes the possibility of failure in the type system, making error cases explicit and composable.
 *
 * @param <T>
 *            The type of the successful result value
 * @param <E>
 *            The type of the error/failure information
 */
@NullMarked
public sealed interface Result<T, E> {
    ...
    /**
     * Applies a function to the error if this is a failure. Unlike mapError, this takes a Result, allowing fallback
     * recovery.
     */
